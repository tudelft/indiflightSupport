...
tmux send-keys -t $session:0.0 "./UnifiedOptitrackClients/build/client optitrack udp -f 20 --coordinate_north far_side --streaming_ids 4 --craft_noses far_side -l near_side -i 10.0.0.1 -c NED" 
