...
#tmux send-keys -t $session:0.3 "$ON_PI /home/pi/relay/build-aarch64-linux-gnu/relay" ENTER
...
# setpoints
tmux send-keys -t $session:0.1 './setpoint_sender/setpointSender.py --pos 0 0 -1.0 --yaw 0'

# keyboards
tmux send-keys -t $session:0.2 './keyInputs.py' ENTER
