...
a = set init speed 100 perc
b = set init speed 105 perc
c = set init speed 110 perc
d = set init speed 115 perc
e = set init speed 120 perc
f = set init speed 125 perc
g = start trajectory 80 perc speed
h = increment height offset +0.1
l = increment height offset -0.1
n = enable autostart
m = disable autostart
